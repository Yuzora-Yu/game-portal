...
<body>
  ...
  <header class="site-header"><div class="site-header__inner"><a class="brand" href="../"><span class="brand__mark" aria-hidden="true">◆</span><span><strong>YU-ZORA GAME PORTAL</strong><small>個人制作ブラウザゲーム保管庫</small></span></a><nav class="global-nav" aria-label="主要ナビゲーション"><a class="global-nav__archive" href="https://yu-zora.com/" aria-label="YU-ZORAトップへ戻る">YU-ZORA ↗</a><a href="../#games">GAMES</a><a href="../news.html" aria-current="page">NEWS</a><a href="../developer.html">DEVELOPER</a><a href="../privacy.html">PRIVACY</a></nav></div></header>
