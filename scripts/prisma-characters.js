(() => {
  const characters = [
    ...
    { id: 403, label: "STORY CHARACTER", name: "ルーナ", job: "祈り手", profile: "山奥の村でアルスと共に育った、明るく心優しい少女。光神の祠に花を供え、危機の中でも誰かを助けようと手を伸ばす。", art: "./assets/prisma-character-lineup/luna-403.png", face: "./assets/prisma-character-lineup/luna-403.png", portrait: true },
